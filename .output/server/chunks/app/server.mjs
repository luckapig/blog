import { v as vue_cjs_prod, s as serverRenderer, r as require$$0 } from '../index2.mjs';
...
const vueuseHead_20b21d16 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_4700c10a = defineNuxtPlugin((nuxtApp) => {
...
const NuxtNestedPage = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$4]]);
const layouts = {
  "home": vue_cjs_prod.defineAsyncComponent({ suspensible: false, loader: () => Promise.resolve().then(function() {
    return home$1;
  }) })
};
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_RouterView, _attrs, {
    default: vue_cjs_prod.withCtx(({ Component, route }, _push2, _parent2, _scopeId) => {
      var _a, _b;
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_NuxtTransition, {
          options: (_a = route.meta.layoutTransition) != null ? _a : { name: "layout", mode: "out-in" }
        }, {
          default: vue_cjs_prod.withCtx((_, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              if (Component) {
                _push3(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, {
                  name: _ctx.layout || route.meta.layout
                }, {
                  default: vue_cjs_prod.withCtx((_2, _push4, _parent4, _scopeId3) => {
                    var _a2, _b2;
                    if (_push4) {
                      _push4(serverRenderer.exports.ssrRenderComponent(_component_NuxtTransition, {
                        options: (_a2 = route.meta.pageTransition) != null ? _a2 : { name: "page", mode: "out-in" }
                      }, {
                        default: vue_cjs_prod.withCtx((_3, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            serverRenderer.exports.ssrRenderSuspense(_push5, {
                              default: () => {
                                serverRenderer.exports.ssrRenderVNode(_push5, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent(Component), null, null), _parent5, _scopeId4);
                              },
                              _: 2
                            });
                          } else {
                      ...
                      return [
                        vue_cjs_prod.createVNode(_component_NuxtTransition, {
                          options: (_b2 = route.meta.pageTransition) != null ? _b2 : { name: "page", mode: "out-in" }
                        }, {
                          default: vue_cjs_prod.withCtx(() => [
                            (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.Suspense, {
                              onPending: () => _ctx.onSuspensePending(Component),
        ...
        return [
          vue_cjs_prod.createVNode(_component_NuxtTransition, {
            options: (_b = route.meta.layoutTransition) != null ? _b : { name: "layout", mode: "out-in" }
          }, {
            default: vue_cjs_prod.withCtx(() => [
              Component ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_NuxtLayout, {
                key: 0,
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$3]]);
const useLoadStatus = () => useState("isLoading", () => {
  return false;
});
const useBlogSettings = () => useState("blogSettings", () => {
  return {};
});
const useStoreBlogSettings = () => useState("storeBlogSettings", () => {
  return false;
});
const useHeadMessage = () => useState("headMessage", () => {
  return "";
});
const useErrorMessage = () => useState("errorMessage", () => {
  return "";
});
const __default__$4 = {
  name: "[id]",
    ...
    loadArticle() {
      ...
      axios.get("/api/article", {
        ...
        if (!response.data.password) {
          ...
          axios.get(response.data.contentUrl).then((contentResponse) => {
...
const _sfc_main$7 = /* @__PURE__ */ Object.assign(__default__$4, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "border-3 border-green-500 border-dashed rounded-lg p-2" }, _attrs))} data-v-aafd3df8>`);
      if (_ctx.password) {
        _push(`<div data-v-aafd3df8><div class="text-3xl text-green-800 dark:text-green-100" data-v-aafd3df8>\u8BF7\u8F93\u5165\u5BC6\u7801\uFF1A</div><div class="flex-col my-4" data-v-aafd3df8><div class="flex justify-center" data-v-aafd3df8><div class="${serverRenderer.exports.ssrRenderClass([_ctx.borderColor, "border-3 border-dashed rounded-md w-md"])}" data-v-aafd3df8><div class="${serverRenderer.exports.ssrRenderClass([_ctx.blurLevel, "filter"])}" data-v-aafd3df8><input${serverRenderer.exports.ssrRenderAttr("value", _ctx.myPassword)} class="w-full text-center dark:bg-dark dark:text-green-100" style="${serverRenderer.exports.ssrRenderStyle({ "outline": "none" })}" data-v-aafd3df8></div></div><button class="w-8 h-8 ml-4 text-2xl text-red-600" data-v-aafd3df8>\u2611</button></div></div></div>`);
      } else {
        _push(`<div data-v-aafd3df8>`);
        if (_ctx.contentType === "html") {
          _push(`<div data-v-aafd3df8><iframe class="w-full" style="${serverRenderer.exports.ssrRenderStyle({ "height": "calc(100vh - 8.5rem)" })}"${serverRenderer.exports.ssrRenderAttr("srcdoc", _ctx.content)} data-v-aafd3df8></iframe></div>`);
        } else if (_ctx.contentType === "md" || _ctx.contentType === "markdown") {
          _push(`<div data-v-aafd3df8><div class="dark:text-green-100 dark:bg-dark markdown-body w-full" data-v-aafd3df8>${_ctx.content}</div></div>`);
        } else if (_ctx.contentType === "txt") {
          _push(`<div data-v-aafd3df8><div class="dark:text-green-100" style="${serverRenderer.exports.ssrRenderStyle({ "white-space": "pre-wrap" })}" data-v-aafd3df8>${serverRenderer.exports.ssrInterpolate(_ctx.content)}</div></div>`);
        } else if (_ctx.contentType === "url") {
          _push(`<div data-v-aafd3df8><iframe class="w-full" style="${serverRenderer.exports.ssrRenderStyle({ "height": "calc(100vh - 8.5rem)" })}"${serverRenderer.exports.ssrRenderAttr("src", _ctx.content)} data-v-aafd3df8></iframe></div>`);
        } else if (_ctx.contentType === "redirect") {
          _push(`<div data-v-aafd3df8><div class="dark:text-green-100" style="${serverRenderer.exports.ssrRenderStyle({ "white-space": "pre-wrap", "text-align": "center" })}" data-v-aafd3df8> \u5373\u5C06\u8DF3\u8F6C\u81F3 <span class="text-green-800 dark:text-green-100" data-v-aafd3df8>${serverRenderer.exports.ssrInterpolate(_ctx.content)}</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
  ...
  methods: {
    getArticle(page) {
      ...
      axios.get("/api/index", {
        ...
        if (page === 1) {
          await axios.get(response.data.settingsUrl).then((response2) => {
            getSettings(response2.data);
          }).catch((error) => {
            getStatusCode(error.response.status);
          }).finally(() => {
            stopLoading(1);
    ...
    getConfig(name) {
      if (this.blogSettings !== void 0) {
        if (this.blogSettings[name] !== void 0) {
...
const _sfc_main$6 = /* @__PURE__ */ Object.assign(__default__$3, {
  ...
  setup(__props) {
    ...
    useHeadMessage();
    useBlogSettings();
    useStoreBlogSettings();
    useErrorMessage();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
      if (_ctx.statusCode === 200) {
        _push(`<div><div class="text-4xl text-green-500 font-bold">${serverRenderer.exports.ssrInterpolate(_ctx.getConfig("saying"))}</div><!--[-->`);
        serverRenderer.exports.ssrRenderList(_ctx.article, (a) => {
          _push(`<div><div class="flex-col justify-between h-auto w-full mx-auto my-4 p-4 border-3 border-green-500 border-dashed rounded-lg"><div class="text-2xl dark:text-green-100">${serverRenderer.exports.ssrInterpolate(a.title)}</div><div class="text-md text-gray-500 dark:text-green-100">${serverRenderer.exports.ssrInterpolate(a.updateDate)}</div><div class="flex w-full justify-end">`);
          _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
            to: "/article/" + a.id
          }, {
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="bg-green-100 dark:bg-green-900 dark:text-green-100 p-1 border-3 border-green-500 border-dashed rounded-lg text-green-800 font-bold"${_scopeId}>${serverRenderer.exports.ssrInterpolate(_ctx.getConfig("button"))}</div>`);
              } else {
                return [
                  vue_cjs_prod.createVNode("div", { class: "bg-green-100 dark:bg-green-900 dark:text-green-100 p-1 border-3 border-green-500 border-dashed rounded-lg text-green-800 font-bold" }, vue_cjs_prod.toDisplayString(_ctx.getConfig("button")), 1)
                ];
              }
            }),
            _: 2
        ...
        _push(`<!--]-->`);
        if (_ctx.article.length === 0) {
          _push(`<div> \u7A7A </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="text-center"><button class="text-2xl">\u2B05\uFE0F</button><span class="text-md text-gray-500 dark:text-green-100 px-2 border-3 border-green-500 border-dashed rounded-lg">${serverRenderer.exports.ssrInterpolate(_ctx.nowPage)}</span><button class="text-2xl">\u27A1\uFE0F</button></div></div>`);
      } else {
        _push(`<div><div class="text-4xl">${serverRenderer.exports.ssrInterpolate(_ctx.statusCode)}</div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const router_34814355 = defineNuxtPlugin((nuxtApp) => {
...
const nitroClient_707c1b34 = () => {
};
const components = {
  "Loading": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return loading$1;
  }).then((c) => c.default || c))
};
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$4 = {
  setup() {
...
const _imports_0$1 = `${NUXT_BASE$1}onedrive.png`;
const __default__$2 = {
  name: "home",
  data() {
    return {
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign(__default__$2, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-4fb27cd2><header class="fixed z-10 top-0 left-0 h-18 w-full backdrop-filter backdrop-blur bg-white dark:bg-dark bg-opacity-80 dark:backdrop-filter dark:backdrop-blur dark:bg-opacity-80" data-v-4fb27cd2><div class="flex h-18 items-center" data-v-4fb27cd2><button class="ml-3 mr-1 text-2xl text-green-500 dark:text-green-100" data-v-4fb27cd2>\u21A9</button><button class="mr-3 ml-1 text-2xl" data-v-4fb27cd2>${serverRenderer.exports.ssrInterpolate(_ctx.modeIcon)}</button><div class="mx-2 cursor-pointer text-xl font-mono font-medium dark:text-green-100" data-v-4fb27cd2>OneDrive/Blog</div><div class="mx-2 flex-1 text-xl font-mono text-green-500 dark:text-green-100" data-v-4fb27cd2>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(headMessage))}</div><div class="mx-2 text-xl font-mono font-medium text-green-500 dark:text-green-100" data-v-4fb27cd2>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(config).WEBSITE_NAME)}</div></div></header><div class="h-18 w-full" data-v-4fb27cd2></div>`);
      if (vue_cjs_prod.unref(isLoading) || vue_cjs_prod.unref(errorMessage) !== "") {
        _push(`<div data-v-4fb27cd2><div class="fixed h-full w-full z-20 flex justify-center items-center backdrop-filter backdrop-blur" data-v-4fb27cd2><div class="mb-48 flex-col place-content-center" data-v-4fb27cd2><div class="flex justify-center" data-v-4fb27cd2><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$1)} alt="Loading" class="${serverRenderer.exports.ssrRenderClass([_ctx.animateClass, "filter -hue-rotate-45"])}" data-v-4fb27cd2></div><div class="flex justify-center" data-v-4fb27cd2><div class="text-2xl text-green-900 dark:text-green-100 mx-1" data-v-4fb27cd2>${serverRenderer.exports.ssrInterpolate(_ctx.errorInfo)}</div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="container mx-auto my-4 z-0" data-v-4fb27cd2>`);
...
const home = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4fb27cd2"]]);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-aafd3df8"]]);
...
const _imports_0 = joinURL(NUXT_BASE, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/onedrive.74f43d3f.png".replace("/__NUXT_BASE__", ""));
const _sfc_main = {
  name: "loading"
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex fixed top-0 left-0 z-20 w-screen h-screen justify-center items-center backdrop-filter backdrop-blur" }, _attrs))}><div><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="logo" class="filter -hue-rotate-45 animate-pulse"></div></div>`);
}
...
const loading$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": loading
});
