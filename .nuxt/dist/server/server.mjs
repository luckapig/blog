...
import require$$0, { reactive, getCurrentInstance, toRef, ref, computed, defineComponent, resolveComponent, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext, defineAsyncComponent, h, Transition, Suspense, createCommentVNode, mergeProps, toDisplayString as toDisplayString$1, shallowRef, createApp, unref } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense, ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderSlot } from "vue/server-renderer";
...
const layouts = {
  "home": defineAsyncComponent({ suspensible: false, loader: () => Promise.resolve().then(function() {
    return home$1;
  }) })
};
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_RouterView = resolveComponent("RouterView");
  const _component_NuxtTransition = resolveComponent("NuxtTransition");
  const _component_NuxtLayout = resolveComponent("NuxtLayout");
  _push(ssrRenderComponent(_component_RouterView, _attrs, {
    default: withCtx(({ Component, route }, _push2, _parent2, _scopeId) => {
      var _a, _b;
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtTransition, {
          options: (_a = route.meta.layoutTransition) != null ? _a : { name: "layout", mode: "out-in" }
        }, {
          default: withCtx((_, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              if (Component) {
                _push3(ssrRenderComponent(_component_NuxtLayout, {
                  name: _ctx.layout || route.meta.layout
                }, {
                  default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                    var _a2, _b2;
                    if (_push4) {
                      _push4(ssrRenderComponent(_component_NuxtTransition, {
                        options: (_a2 = route.meta.pageTransition) != null ? _a2 : { name: "page", mode: "out-in" }
                      }, {
                        default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ssrRenderSuspense(_push5, {
                              default: () => {
                                ssrRenderVNode(_push5, createVNode(resolveDynamicComponent(Component), null, null), _parent5, _scopeId4);
                              },
                              _: 2
                            });
                          } else {
                      ...
                      return [
                        createVNode(_component_NuxtTransition, {
...
const _id__vue_vue_type_style_index_0_scoped_true_lang = "";
const __default__$4 = {
  name: "[id]",
  data() {
    return {
...
const _sfc_main$7 = /* @__PURE__ */ Object.assign(__default__$4, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "border-3 border-green-500 border-dashed rounded-lg p-2" }, _attrs))} data-v-aafd3df8>`);
      if (_ctx.password) {
        _push(`<div data-v-aafd3df8><div class="text-3xl text-green-800 dark:text-green-100" data-v-aafd3df8>\u8BF7\u8F93\u5165\u5BC6\u7801\uFF1A</div><div class="flex-col my-4" data-v-aafd3df8><div class="flex justify-center" data-v-aafd3df8><div class="${ssrRenderClass([_ctx.borderColor, "border-3 border-dashed rounded-md w-md"])}" data-v-aafd3df8><div class="${ssrRenderClass([_ctx.blurLevel, "filter"])}" data-v-aafd3df8><input${ssrRenderAttr("value", _ctx.myPassword)} class="w-full text-center dark:bg-dark dark:text-green-100" style="${ssrRenderStyle({ "outline": "none" })}" data-v-aafd3df8></div></div><button class="w-8 h-8 ml-4 text-2xl text-red-600" data-v-aafd3df8>\u2611</button></div></div></div>`);
      } else {
        _push(`<div data-v-aafd3df8>`);
        if (_ctx.contentType === "html") {
          _push(`<div data-v-aafd3df8><iframe class="w-full" style="${ssrRenderStyle({ "height": "calc(100vh - 8.5rem)" })}"${ssrRenderAttr("srcdoc", _ctx.content)} data-v-aafd3df8></iframe></div>`);
          ...
          _push(`<div data-v-aafd3df8><div class="dark:text-green-100" style="${ssrRenderStyle({ "white-space": "pre-wrap" })}" data-v-aafd3df8>${ssrInterpolate(_ctx.content)}</div></div>`);
        } else if (_ctx.contentType === "url") {
          _push(`<div data-v-aafd3df8><iframe class="w-full" style="${ssrRenderStyle({ "height": "calc(100vh - 8.5rem)" })}"${ssrRenderAttr("src", _ctx.content)} data-v-aafd3df8></iframe></div>`);
        } else if (_ctx.contentType === "redirect") {
          _push(`<div data-v-aafd3df8><div class="dark:text-green-100" style="${ssrRenderStyle({ "white-space": "pre-wrap", "text-align": "center" })}" data-v-aafd3df8> \u5373\u5C06\u8DF3\u8F6C\u81F3 <span class="text-green-800 dark:text-green-100" data-v-aafd3df8>${ssrInterpolate(_ctx.content)}</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.statusCode === 200) {
        _push(`<div><div class="text-4xl text-green-500 font-bold">${ssrInterpolate(_ctx.getConfig("saying"))}</div><!--[-->`);
        ssrRenderList(_ctx.article, (a) => {
          _push(`<div><div class="flex-col justify-between h-auto w-full mx-auto my-4 p-4 border-3 border-green-500 border-dashed rounded-lg"><div class="text-2xl dark:text-green-100">${ssrInterpolate(a.title)}</div><div class="text-md text-gray-500 dark:text-green-100">${ssrInterpolate(a.updateDate)}</div><div class="flex w-full justify-end">`);
          _push(ssrRenderComponent(_component_nuxt_link, {
            to: "/article/" + a.id
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="bg-green-100 dark:bg-green-900 dark:text-green-100 p-1 border-3 border-green-500 border-dashed rounded-lg text-green-800 font-bold"${_scopeId}>${ssrInterpolate(_ctx.getConfig("button"))}</div>`);
              } else {
                return [
                  createVNode("div", { class: "bg-green-100 dark:bg-green-900 dark:text-green-100 p-1 border-3 border-green-500 border-dashed rounded-lg text-green-800 font-bold" }, toDisplayString$1(_ctx.getConfig("button")), 1)
                ];
              }
            }),
            _: 2
        ...
        _push(`<div class="text-center"><button class="text-2xl">\u2B05\uFE0F</button><span class="text-md text-gray-500 dark:text-green-100 px-2 border-3 border-green-500 border-dashed rounded-lg">${ssrInterpolate(_ctx.nowPage)}</span><button class="text-2xl">\u27A1\uFE0F</button></div></div>`);
      } else {
        _push(`<div><div class="text-4xl">${ssrInterpolate(_ctx.statusCode)}</div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const components = {
  "Loading": defineAsyncComponent(() => Promise.resolve().then(function() {
    return loading$1;
  }).then((c) => c.default || c))
};
...
const githubMarkdown_css_vue_type_style_index_0_src_4fb27cd2_lang = "";
const home_vue_vue_type_style_index_1_scoped_true_lang = "";
const __default__$2 = {
  name: "home",
  data() {
    return {
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign(__default__$2, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-4fb27cd2><header class="fixed z-10 top-0 left-0 h-18 w-full backdrop-filter backdrop-blur bg-white dark:bg-dark bg-opacity-80 dark:backdrop-filter dark:backdrop-blur dark:bg-opacity-80" data-v-4fb27cd2><div class="flex h-18 items-center" data-v-4fb27cd2><button class="ml-3 mr-1 text-2xl text-green-500 dark:text-green-100" data-v-4fb27cd2>\u21A9</button><button class="mr-3 ml-1 text-2xl" data-v-4fb27cd2>${ssrInterpolate(_ctx.modeIcon)}</button><div class="mx-2 cursor-pointer text-xl font-mono font-medium dark:text-green-100" data-v-4fb27cd2>OneDrive/Blog</div><div class="mx-2 flex-1 text-xl font-mono text-green-500 dark:text-green-100" data-v-4fb27cd2>${ssrInterpolate(unref(headMessage))}</div><div class="mx-2 text-xl font-mono font-medium text-green-500 dark:text-green-100" data-v-4fb27cd2>${ssrInterpolate(unref(config).WEBSITE_NAME)}</div></div></header><div class="h-18 w-full" data-v-4fb27cd2></div>`);
      if (unref(isLoading) || unref(errorMessage) !== "") {
        _push(`<div data-v-4fb27cd2><div class="fixed h-full w-full z-20 flex justify-center items-center backdrop-filter backdrop-blur" data-v-4fb27cd2><div class="mb-48 flex-col place-content-center" data-v-4fb27cd2><div class="flex justify-center" data-v-4fb27cd2><img${ssrRenderAttr("src", _imports_0$1)} alt="Loading" class="${ssrRenderClass([_ctx.animateClass, "filter -hue-rotate-45"])}" data-v-4fb27cd2></div><div class="flex justify-center" data-v-4fb27cd2><div class="text-2xl text-green-900 dark:text-green-100 mx-1" data-v-4fb27cd2>${ssrInterpolate(_ctx.errorInfo)}</div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex fixed top-0 left-0 z-20 w-screen h-screen justify-center items-center backdrop-filter backdrop-blur" }, _attrs))}><div><img${ssrRenderAttr("src", _imports_0)} alt="logo" class="filter -hue-rotate-45 animate-pulse"></div></div>`);
}
