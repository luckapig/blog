import require$$0$4, { existsSync, readdirSync as readdirSync$1 } from 'fs';
...
const { resolve, parse: parse$2 } = require$$0$3;
...
const fs$7 = commonjsGlobal.__FAKE_TESTING_FS__ || require$$0$4;
